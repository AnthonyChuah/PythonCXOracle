...
query = "SELECT USERNAME, FILENAME, FOLDERNAME, CREATED_AT, COMPANY, NAME FROM (SELECT * FROM DBUSER.TABLENAME) WHERE USERNAME NOT LIKE \'%@MYCOMPANY.COM\' ORDER BY CREATED_AT"
